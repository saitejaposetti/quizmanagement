...
Quiz quiz = new Quiz();
Question question1=new Question(1,"What is the capital of france?",Arrays.asList("A.paris","B.london","c.rome","d.berin"),0);
Question question2=new Question(2,"What is the captain of indian cricket team?",Arrays.asList("A.Virat kohli","M S Dhoni","Ricky ponting","Rahul Dravid"),0);
